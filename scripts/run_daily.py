...
def run():
    ...
    # Step 1: Download
    print("[1/10] Downloading OFAC lists ...")
    try:
    ...
    print("[5/10] Generating AI summary ...")
    try:
    ...
    print("[7/10] Building program data ...")
    try:
    ...
    print("[8/10] Building overview stats ...")
    try:
    ...
    print("[9/10] Building full registry ...")
    try:
    ...
    # Step 10: Build activity timeline
    print("[10/10] Building activity timeline ...")
    try:
        from build_timeline import build_and_save as build_tl
        build_tl()
        print()
    except Exception as e:
        print(f"  ERROR in build_timeline: {e}\n")
